...
[Positron](https://positron.posit.co/) is a "_free, AI-assisted environment, empowering the full spectrum of data science in Python and R._"

![](images/positron.png){width='100%' fig-align='center'}

### VS Code 

VS Code is a popular IDE for Python developers 

![](images/vs_code.png){width='100%' fig-align='center'}
